...
export class PikaPerpV3__getPositionResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class PikaPerpV3__getPositionsResult_positionsStruct extends ethereum.Tuple {
  get productId(): BigInt {
    return this[0].toBigInt();
  }
...
export class PikaPerpV3__getProductResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class PikaPerpV3__getStakeResultValue0Struct extends ethereum.Tuple {
  get owner(): Address {
    return this[0].toAddress();
  }
...
export class PikaPerpV3__getVaultResultValue0Struct extends ethereum.Tuple {
  get cap(): BigInt {
    return this[0].toBigInt();
  }
...
export class PikaPerpV3 extends ethereum.SmartContract {
  static bind(address: Address): PikaPerpV3 {
    return new PikaPerpV3("PikaPerpV3", address);
  }
  ...
  getPosition(
    ...
    return new PikaPerpV3__getPositionResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getPosition(
    ...
    productId: BigInt,
    isLong: boolean
  ): ethereum.CallResult<PikaPerpV3__getPositionResult> {
    let result = super.tryCall(
      "getPosition",
      "getPosition(address,uint256,bool):(uint256,uint256,uint256,uint256,uint256,address,uint256,bool,int256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new PikaPerpV3__getPositionResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getPositions(
  ...
  ): Array<PikaPerpV3__getPositionsResult_positionsStruct> {
    let result = super.call(
      "getPositions",
    ...
    return result[0].toTupleArray<
      PikaPerpV3__getPositionsResult_positionsStruct
    >();
  }
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<PikaPerpV3__getPositionsResult_positionsStruct>()
    );
  }

  getProduct(productId: BigInt): PikaPerpV3__getProductResult {
    let result = super.call(
      "getProduct",
    ...
    return new PikaPerpV3__getProductResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean(),
  ...
  try_getProduct(
    productId: BigInt
  ): ethereum.CallResult<PikaPerpV3__getProductResult> {
    let result = super.tryCall(
      "getProduct",
      "getProduct(uint256):(address,uint256,uint256,bool,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(productId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PikaPerpV3__getProductResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean(),
  ...
  getStake(stakeOwner: Address): PikaPerpV3__getStakeResultValue0Struct {
    let result = super.call(
      "getStake",
    ...
    return result[0].toTuple() as PikaPerpV3__getStakeResultValue0Struct;
  }

  try_getStake(
    stakeOwner: Address
  ): ethereum.CallResult<PikaPerpV3__getStakeResultValue0Struct> {
    let result = super.tryCall(
      "getStake",
      "getStake(address):((address,uint96,uint128,uint128))",
      [ethereum.Value.fromAddress(stakeOwner)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as PikaPerpV3__getStakeResultValue0Struct
    );
  }
  ...
  getVault(): PikaPerpV3__getVaultResultValue0Struct {
    let result = super.call(
      "getVault",
    ...
    return result[0].toTuple() as PikaPerpV3__getVaultResultValue0Struct;
  }

  try_getVault(): ethereum.CallResult<PikaPerpV3__getVaultResultValue0Struct> {
    let result = super.tryCall(
      "getVault",
      "getVault():((uint128,uint128,uint96,uint96,uint64))",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as PikaPerpV3__getVaultResultValue0Struct
    );
  }
  ...
  try_liquidationBounty(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "liquidationBounty",
      "liquidationBounty():(uint256)",
      []
...
export class SetParametersCall__Inputs {
  ...
  get _isManagerOnlyForOpen(): boolean {
    return this._call.inputValues[4].value.toBoolean();
  }

  get _isManagerOnlyForClose(): boolean {
